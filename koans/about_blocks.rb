...
class AboutBlocks < EdgeCase::Koan
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    ...
    # Okay this is one confusing way to call
    # 1. we've a dynamically typed language
    # 2. looking at add_one[10] alone one can't figure out
    #    if that's an array or a lambda
  end
