...
class AboutStrings < EdgeCase::Koan
  ...
  def test_use_flexible_quoting_to_handle_really_hard_cases
    ...
    # % notation is great, seems like one can use any special
...
EOS
    ...
    # So the document marker considers everything from the newline 
    # as the string
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # 
    # += leads to creation of new string object (as seen with object_id 
    # differences)
    # Whereas << results in no new object allocation -
    #  hence faster
    #  and doesn't make more garbage to be cleaned up
  ...
  def test_single_quoted_string_do_not_interpret_escape_characters
    ...
    # Dman! well double quotes and multilines seem to be 
    # cool enough for practical purposes
  end
  ...
  def test_single_quotes_sometimes_interpret_escape_characters
    ...
    assert_equal 2, string.size
    assert_equal "\\'", string
    # Yeah! double quotes are cool enough to avoid all
    # the confusion, weird, its \' when you print it with puts
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Yeah!
    # Okay so ruby 1.93p0 puts out "a" instead
    # whereas 1.8.x stick to Fixnum representations
  end
