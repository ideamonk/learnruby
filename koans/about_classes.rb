...
class AboutClasses < EdgeCase::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name("Fido")
    assert_equal [:@name], fido.instance_variables # Ruby 1.9.2 doesn't use strings
  end
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # For obvious absence of a default value for initial_name in 
    # constructor
  end
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    assert_equal "[1, 2, 3]", array.to_s # Ah this too changed in Ruby 1.9.2
