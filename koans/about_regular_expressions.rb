...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # An asterik, checking for presence of zero of more
    # occurances of a pattern would never fail I suppose.
  end
  ...
  #
  # Why?
  # Hmm all of them can make a selection choice to start the search.
  # Like z*, can proceed if str.include? "z" == true , else it can short
  # circuit to a return ""
  # Hmm, I wouldn't know more right now.
  # Hmm, they start finding matches from first occurance of partials
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    # aha, useful but could turn code cryptic
    # inspirations from perl's $_ :)
  end
  ...
  # [ ] works purely at character leve, it wouldn't consider multiple characters
  # separated by or. Whereas (|) matches groups easily -
  # >> "abcd"[/[ab|b|c]/]
  # => "a"
  # >> "abcd"[/(ab|b|c)/]
  # => "ab"
  # Hmm, mostly clueless about more differences.
