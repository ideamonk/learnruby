...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # well backward compatibility I guess, really no clue!
    #
  end
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    # but well, is this a change in ruby 1.9.2, was respond_to?
    # supposed to lie with a true in 1.8.x ?
  end
